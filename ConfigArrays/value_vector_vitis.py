...
def main():
    ...
    p.add_argument("-i", "--input",  default="value_vectors.txt", help="Eingabedatei (eine Zeile = 10000 Bits)")
    p.add_argument("-o", "--output", default="value_vectors_array.h", help="Ausgabedatei (.h oder .c)")
    ...
    p.add_argument("--name",            default="value_vectors", help="C-Array-Name (default: value_vectors)")
