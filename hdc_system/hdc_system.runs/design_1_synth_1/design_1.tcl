...
namespace eval ::optrace {
  variable script "D:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.runs/design_1_synth_1/design_1.tcl"
...
if { [catch {
  file copy -force D:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.runs/design_1_synth_1/design_1.dcp d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if {[file isdir D:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.ip_user_files/bd/design_1]} {
  catch { 
    file copy -force d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1_stub.v D:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.ip_user_files/bd/design_1
  }
}

if {[file isdir D:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.ip_user_files/bd/design_1]} {
  catch { 
    file copy -force d:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.gen/sources_1/bd/design_1/design_1_stub.vhdl D:/Documents/FAU/VITISDEBUGGING/VITISDEBUGGING.ip_user_files/bd/design_1
  }
}
