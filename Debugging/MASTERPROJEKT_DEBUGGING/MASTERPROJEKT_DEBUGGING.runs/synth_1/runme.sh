...
HD_PWD='D:/Documents/FAU/MASTERPROJEKT_DEBUGGING/MASTERPROJEKT_DEBUGGING.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HDC_Controller_AXI_Wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HDC_Controller_AXI_Wrapper.tcl
